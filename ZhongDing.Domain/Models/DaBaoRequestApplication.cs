...
namespace ZhongDing.Domain.Models
{
    ...
    [Serializable]
    public partial class DaBaoRequestApplication : IEntityExtendedProperty
    {
        public DaBaoRequestApplication()
        {
            this.DaBaoRequestAppDetail = new HashSet<DaBaoRequestAppDetail>();
        }
    
        public int ID { get; set; }
        public Nullable<int> DaBaoApplicationID { get; set; }
        ...
        public virtual DaBaoApplication DaBaoApplication { get; set; }
