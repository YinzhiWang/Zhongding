...
namespace ZhongDing.Domain.Models
{
    ...
    [Serializable]
    public partial class StockInImportFileLog : IEntityExtendedProperty
    {
        public StockInImportFileLog()
        {
            this.StockInImportData = new HashSet<StockInImportData>();
        }
        ...
        public virtual ICollection<StockInImportData> StockInImportData { get; set; }
    }
}
