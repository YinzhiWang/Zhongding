...
namespace ZhongDing.Domain.Models
{
    ...
    [Serializable]
    public partial class ImportDataType : IEntityExtendedProperty
    {
        public ImportDataType()
        {
            this.ImportFileLog = new HashSet<ImportFileLog>();
        }
        ...
        public virtual ICollection<ImportFileLog> ImportFileLog { get; set; }
    }
}
