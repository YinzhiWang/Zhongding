...
namespace ZhongDing.Domain.Models
{
    ...
    [Serializable]
    public partial class DeptMarketProduct : IEntityExtendedProperty
    {
        public int ID { get; set; }
        public int MarketDivisionID { get; set; }
        public int ProductID { get; set; }
        public Nullable<int> Q1Task { get; set; }
        public Nullable<int> Q2Task { get; set; }
        public Nullable<int> Q3Task { get; set; }
        public Nullable<int> Q4Task { get; set; }
