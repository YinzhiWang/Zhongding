...
namespace ZhongDing.Domain.Models
{
    ...
    [Serializable]
    public partial class CashFlowDistributionCompanyData : IEntityExtendedProperty
    {
        public int ID { get; set; }
        public int CashFlowBaseDataID { get; set; }
        ...
        public virtual CashFlowBaseData CashFlowBaseData { get; set; }
