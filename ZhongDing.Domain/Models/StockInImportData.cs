...
namespace ZhongDing.Domain.Models
{
    ...
    [Serializable]
    public partial class StockInImportData : IEntityExtendedProperty
    {
        public StockInImportData()
        {
            this.StockInDetailImportData = new HashSet<StockInDetailImportData>();
        }
        ...
        public virtual ICollection<StockInDetailImportData> StockInDetailImportData { get; set; }
        public virtual StockInImportFileLog StockInImportFileLog { get; set; }
    }
}
