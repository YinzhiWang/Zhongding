...
namespace ZhongDing.Domain.Models
{
    ...
    [Serializable]
    public partial class ProcureOrderApplicationImportFileLog : IEntityExtendedProperty
    {
        public ProcureOrderApplicationImportFileLog()
        {
            this.ProcureOrderApplicationImportData = new HashSet<ProcureOrderApplicationImportData>();
        }
        ...
        public virtual ICollection<ProcureOrderApplicationImportData> ProcureOrderApplicationImportData { get; set; }
    }
}
