...
namespace ZhongDing.Domain.Models
{
    ...
    [Serializable]
    public partial class SupplierCautionMoneyDeduction : IEntityExtendedProperty
    {
        public int ID { get; set; }
        public int SupplierCautionMoneyID { get; set; }
        public int SupplierID { get; set; }
        public decimal Amount { get; set; }
        public Nullable<System.DateTime> DeductedDate { get; set; }
        ...
        public virtual SupplierCautionMoney SupplierCautionMoney { get; set; }
    }
}
