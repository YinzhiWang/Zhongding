<%@ Page Title="供应商发票结算管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SupplierInvoiceSettlementManagement.aspx.cs" Inherits="ZhongDing.Web.Views.Invoices.SupplierInvoiceSettlementManagement" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "SupplierInvoiceSettlementMaintenance.aspx?EntityID=" + id;
        }
