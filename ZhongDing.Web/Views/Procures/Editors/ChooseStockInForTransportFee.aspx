<%@ Page Title="选择关联单据" Language="C#" MasterPageFile="~/Site.Window.Master" AutoEventWireup="true" CodeBehind="ChooseStockInForTransportFee.aspx.cs" Inherits="ZhongDing.Web.Views.Procures.Editors.ChooseStockInForTransportFee" %>
                        ...
                        <telerik:RadGrid ID="rgStockIns" runat="server" PageSize="10"
                            ...
                            <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="None"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn UniqueName="CreatedBy" HeaderText="操作员" DataField="CreatedBy">
