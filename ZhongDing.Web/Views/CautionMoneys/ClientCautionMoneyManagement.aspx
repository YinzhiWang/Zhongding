<%@ Page Title="供应商保证金管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientCautionMoneyManagement.aspx.cs" Inherits="ZhongDing.Web.Views.CautionMoneys.ClientCautionMoneyManagement" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1" id="lblTitle" runat="server">客户保证金管理</span>
            </div>
            <div class="mws-panel-body">
                <table runat="server" id="tblSearch" class="leftmargin10">
                    <tr class="height40">
                        <th class="width100 middle-td">终止日期：</th>
                ...
                <telerik:RadGrid ID="rgClientCautionMoneys" runat="server" PageSize="10"
                    ...
                    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="PaymentCautionMoney" HeaderText="已收保证金" DataField="PaymentCautionMoney" DataFormatString="￥{0:f2}">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn UniqueName="ReturnCautionMoney" HeaderText="已退保证金" DataField="ReturnCautionMoney" DataFormatString="￥{0:f2}">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            ...
            window.location.href = "ClientCautionMoneyMaintenance.aspx?EntityID=" + id;
        }
    </script>
</asp:Content>
