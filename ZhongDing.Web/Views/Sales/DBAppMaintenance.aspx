<%@ Page Title="大包配送订单维护" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DBAppMaintenance.aspx.cs" Inherits="ZhongDing.Web.Views.Sales.DBAppMaintenance" %>
    ...
    <div class="container">
        ...
        <div class="mws-panel grid_full">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-sign-post">大包配送订单维护</span>
            </div>
                    ...
                    <div class="mws-form-inline">
                        ...
                        <div class="mws-form-row">
                            ...
                            <div class="float-left">
                                <label>订单日期</label>
                                <div class="mws-form-item toppadding5">
                                    <telerik:RadTextBox runat="server" ID="txtOrderDate" CssClass="mws-textinput"
                                        Width="80%" Enabled="false">
                                    </telerik:RadTextBox>
                                </div>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function redirectToManagementPage(sender, args) {
            redirectToPage("Views/Sales/DBAppManagement.aspx");
        }
        ...
        function refreshMaintenancePage(sender, args) {
            ...
            redirectToPage("Views/Sales/DBAppMaintenance.aspx?EntityID=" + currentEntityID);
        }

        function openOrderProductWindow(id) {
            $.showLoading();

            var targetUrl = $.getRootPath() + "Views/Sales/Editors/DBOrderProductMaintain.aspx?EntityID=" + id
                + "&OwnerEntityID=" + currentEntityID + "&GridClientID=" + gridClientIDs.gridOrderProducts;

            $.openRadWindow(targetUrl, "winOrderProduct", true, 800, 340);
        }
