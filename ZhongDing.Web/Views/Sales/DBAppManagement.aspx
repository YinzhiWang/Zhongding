<%@ Page Title="大包配送订单管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DBAppManagement.aspx.cs" Inherits="ZhongDing.Web.Views.Sales.DBAppManagement" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">大包配送订单管理</span>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "DBAppMaintenance.aspx?EntityID=" + id;
        }
    </script>
</asp:Content>
