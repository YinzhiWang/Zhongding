<%@ Page Title="大包出库单管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DBStockOutManagement.aspx.cs" Inherits="ZhongDing.Web.Views.Sales.DBStockOutManagement" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">大包出库单管理</span>
            </div>
            <div class="mws-panel-body">
                <table runat="server" id="tblSearch" class="leftmargin10">
                    ...
                    <tr class="height40">
                        <th class="width80 middle-td right-td">配送公司：</th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "DBStockOutMaintenance.aspx?EntityID=" + id;
        }
