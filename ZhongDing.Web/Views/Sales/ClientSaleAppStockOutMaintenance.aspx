<%@ Page Title="客户订单出库单维护" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientSaleAppStockOutMaintenance.aspx.cs" Inherits="ZhongDing.Web.Views.Sales.ClientSaleAppStockOutMaintenance" %>
    ...
    <telerik:RadAjaxManager runat="server" ID="RadAjaxManager1">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="ddlClientCompany">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="lblClientCompanyRegistedAddress" />
                    <telerik:AjaxUpdatedControl ControlID="divReceiverInfos" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <div class="container">
        ...
        <div class="mws-panel grid_full">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-sign-post">客户订单出库单维护</span>
            </div>
            <div class="mws-panel-body">
                <div class="mws-form">
                    <div class="mws-form-inline">
                        ...
                        <div class="mws-form-row">
                            <label>商业单位注册地址</label>
                            <div class="mws-form-item medium toppadding5">
                                <asp:Label ID="lblClientCompanyRegistedAddress" runat="server"></asp:Label>
                            </div>
                        </div>
                            ...
                            <div class="float-left width50-percent">
                                ...
                                <div class="mws-form-item" runat="server" id="div1">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvInvoiceType"
                                        ...
                                        ControlToValidate="ddlInvoiceType"
                                        Display="Dynamic" CssClass="field-validation-error"
                                        ValidationGroup="vgMaintenance" Text="*">
                                    </asp:RequiredFieldValidator>
                                </div>
                        ...
                        <div runat="server" id="divReceiverInfos">
                            <div class="mws-form-row">
                                <div class="float-left width50-percent">
                                    <label>收货人</label>
                                            ...
                                            <MasterTableView Width="100%" DataKeyNames="ID,SalesOrderApplicationID,SalesOrderAppDetailID,ProductID,ProductSpecificationID" CommandItemDisplay="Top"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridButtonColumn Text="删除" UniqueName="Delete" CommandName="Delete"
                                                        ...
                                                        <HeaderStyle Width="160" />
                                                        <ItemStyle HorizontalAlign="Justify" Width="160" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function redirectToManagementPage(sender, args) {
            redirectToPage("Views/Sales/ClientSaleAppStockOutManagement.aspx");
        }
        ...
        function refreshMaintenancePage(sender, args) {
            ...
            redirectToPage("Views/Sales/ClientSaleAppStockOutMaintenance.aspx?EntityID=" + currentEntityID);
        }
        ...
        function openChooseOrderProductWindow() {
            ...
            if (clientUserID && clientUserID > 0) {
                var targetUrl = $.getRootPath() + "Views/Sales/Editors/ChooseSalesOrderProducts.aspx?ClientUserID=" + clientUserID
                + "&ClientCompanyID=" + clientCompanyID + "&OwnerEntityID=" + currentEntityID
                + "&GridClientID=" + gridClientIDs.gridStockOutDetails;
