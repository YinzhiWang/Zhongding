<%@ Page Title="商业单位管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientCompanyManagement.aspx.cs" Inherits="ZhongDing.Web.Views.Basics.ClientCompanyManagement" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">商业单位管理</span>
            </div>
                ...
                <telerik:RadGrid ID="rgEntities" runat="server" PageSize="10"
                    ...
                    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="District" HeaderText="地区" DataField="District">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "ClientCompanyMaintenance.aspx?EntityID=" + id;
        }
    </script>
</asp:Content>
