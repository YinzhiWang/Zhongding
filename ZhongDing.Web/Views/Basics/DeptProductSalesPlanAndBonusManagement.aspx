<%@ Page Title="部门货品销售计划及提成策略管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeptProductSalesPlanAndBonusManagement.aspx.cs" Inherits="ZhongDing.Web.Views.Basics.DeptProductSalesPlanAndBonusManagement" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">部门货品销售计划及提成策略管理</span>
            </div>
            <div class="mws-panel-body">
                <table runat="server" id="tblSearch" class="leftmargin10 width60-percent">
                    <tr class="height40">
                        <th class="width40 middle-td">部门：</th>
                        ...
                        <th class="width80 middle-td right-td">货品名称：</th>
                ...
                <telerik:RadGrid ID="rgEntities" runat="server" PageSize="10"
                    ...
                    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="InsideBonusDescription" HeaderText="基础提成比例" DataField="InsideBonusDescription">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="OutsideBonusDescription" HeaderText="超出提成比例" DataField="OutsideBonusDescription">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "DeptProductSalesPlanAndBonusMaintenance.aspx?EntityID=" + id;
        }
    </script>
</asp:Content>
