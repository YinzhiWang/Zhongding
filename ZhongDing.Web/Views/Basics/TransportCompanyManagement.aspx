<%@ Page Title="物流公司管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TransportCompanyManagement.aspx.cs" Inherits="ZhongDing.Web.Views.Basics.TransportCompanyManagement" %>
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnSearch">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="rgTransportCompanys" LoadingPanelID="loadingPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="rgTransportCompanys">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgTransportCompanys" LoadingPanelID="loadingPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">物流公司管理</span>
            </div>
            <div class="mws-panel-body">
                <table runat="server" id="tblSearch" class="leftmargin10">
                    <tr class="height40">
                        ...
                        <td class="middle-td leftpadding10 width50-percent">
                            <telerik:RadTextBox runat="server" ID="txtCompanyName" Label="名称：" LabelWidth="15%" Width="100%" MaxLength="100"></telerik:RadTextBox>
                        </td>
                ...
                <telerik:RadGrid ID="rgTransportCompanys" runat="server" PageSize="10"
                    AllowPaging="True" AllowCustomPaging="true" AllowSorting="True" AutoGenerateColumns="false"
                    MasterTableView-PagerStyle-AlwaysVisible="true" Skin="Silk" Width="99.8%" ShowHeader="true"
                    ClientSettings-ClientEvents-OnRowMouseOver="onRowMouseOver" ClientSettings-ClientEvents-OnRowMouseOut="onRowMouseOut"
                    OnNeedDataSource="rgTransportCompanys_NeedDataSource" OnDeleteCommand="rgTransportCompanys_DeleteCommand"
                    OnItemCreated="rgTransportCompanys_ItemCreated" OnColumnCreated="rgTransportCompanys_ColumnCreated" OnItemDataBound="rgTransportCompanys_ItemDataBound">
                    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="CompanyName" HeaderText="名称" DataField="CompanyName">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="Telephone" HeaderText="电话" DataField="Telephone">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="CompanyAddress" HeaderText="地址" DataField="CompanyAddress">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "TransportCompanyMaintenance.aspx?EntityID=" + id;
        }
    </script>
</asp:Content>
