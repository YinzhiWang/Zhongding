        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnSearch">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="rgReimbursementTypes" LoadingPanelID="loadingPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="rgReimbursementTypes">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgReimbursementTypes" LoadingPanelID="loadingPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">报销类型管理</span>
            </div>
                ...
                <telerik:RadGrid ID="rgReimbursementTypes" runat="server" PageSize="10"
                    ...
                    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="Name" HeaderText="报销类型" DataField="Name">
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "ReimbursementTypeMaintenance.aspx?EntityID=" + id;
        }
    </script>
</asp:Content>
