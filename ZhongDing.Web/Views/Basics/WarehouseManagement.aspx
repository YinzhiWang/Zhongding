        ...
        <div class="mws-panel grid_8">
            ...
            <div class="mws-panel-body">
                <table runat="server" id="tblSearch" class="leftmargin10">
                    <tr class="height40">
                        <td class="middle-td">
                            <telerik:RadTextBox runat="server" ID="txtSerialNo" Label="仓库编号：" LabelWidth="75" MaxLength="50"></telerik:RadTextBox>
                        </td>
                        <td class="middle-td leftpadding10">
                            <telerik:RadTextBox runat="server" ID="txtName" Label="仓库名称：" LabelWidth="75" MaxLength="100"></telerik:RadTextBox>
                        </td>
