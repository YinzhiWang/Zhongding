<%@ Page Title="货品管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductManagement.aspx.cs" Inherits="ZhongDing.Web.Views.Products.ProductManagement" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">货品管理</span>
            </div>
            <div class="mws-panel-body">
                <table runat="server" id="tblSearch" class="leftmargin10">
                    <tr class="height40">
                        <td class="middle-td">
                            <telerik:RadTextBox runat="server" ID="txtProductCode" Label="编号：" LabelWidth="45" MaxLength="50"></telerik:RadTextBox>
                        </td>
                        <td class="middle-td leftpadding10 width50-percent">
                            <telerik:RadTextBox runat="server" ID="txtProductName" Label="名称：" LabelWidth="15%" Width="100%" MaxLength="100"></telerik:RadTextBox>
                        </td>
                ...
                <telerik:RadGrid ID="rgEntities" runat="server" PageSize="10"
                    ...
                    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="ProductCode" HeaderText="编号" DataField="ProductCode">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="ProductName" HeaderText="名称" DataField="ProductName">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="ProductCategoryName" HeaderText="类别" DataField="ProductCategoryName">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
