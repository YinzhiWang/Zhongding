...
{
    public partial class ProductInfoExpiredReminder : BaseReminder
    {
        ...
        {
            return EPermission.ProductInfoExpiredReminder;
        }
        ...
        private void BindReminders(bool isNeedRebind)
        {
            ...
            var entities = PageReminderRepository.GetUIProductInfoExpiredReminder(uiSearchObj, rgEntities.CurrentPageIndex, rgEntities.PageSize, out totalRecords);
