<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductExpiredReminder.ascx.cs" Inherits="ZhongDing.Web.Views.Reminder.UserControls.ProductExpiredReminder" %>
