...
{
    public partial class InventoryReminder : BaseReminder
    {
        ...
        {
            return EPermission.InventoryReminder;
        }
        ...
        private void BindReminders(bool isNeedRebind)
        {
            ...
            var entities = PageReminderRepository.GetUIInventoryReminder(uiSearchObj, rgEntities.CurrentPageIndex, rgEntities.PageSize, out totalRecords);
