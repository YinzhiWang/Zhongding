<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CautionMoneyReminder.ascx.cs" Inherits="ZhongDing.Web.Views.Reminder.UserControls.CautionMoneyReminder" %>
...
<telerik:RadGrid ID="rgEntities" runat="server" PageSize="10"
    ...
    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
        ...
        <Columns>
            ...
            <telerik:GridTemplateColumn UniqueName="ClientOrSupplierName" HeaderText="供应商/客户名称">
                <ItemStyle HorizontalAlign="Left" />
                <ItemTemplate>
                    <a target="_blank" href='<%# Page.ResolveUrl(DataBinder.Eval(Container.DataItem,"Type").ToString()=="客户"
                    ?("~/Views/CautionMoneys/ClientCautionMoneyMaintenance.aspx?EntityID="+DataBinder.Eval(Container.DataItem,"ID").ToString())
                    :("~/Views/CautionMoneys/SupplierCautionMoneyMaintenance.aspx?EntityID="+DataBinder.Eval(Container.DataItem,"ID").ToString()))%>'>
                        <%# DataBinder.Eval(Container.DataItem,"ClientOrSupplierName")%></a>
                </ItemTemplate>
            ...
            <telerik:GridBoundColumn UniqueName="EndDate" HeaderText="有效期" DataField="EndDate" DataFormatString="{0:yyyy/MM/dd}">
                <ItemStyle HorizontalAlign="Left" />
            </telerik:GridBoundColumn>
