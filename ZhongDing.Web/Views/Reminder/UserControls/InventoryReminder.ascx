<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InventoryReminder.ascx.cs" Inherits="ZhongDing.Web.Views.Reminder.UserControls.InventoryReminder" %>
...
<telerik:RadGrid ID="rgEntities" runat="server" PageSize="10"
    ...
    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
        ...
        <Columns>
            ...
            <telerik:GridBoundColumn UniqueName="BalanceQty" HeaderText="剩余存量" DataField="BalanceQty">
                <ItemStyle HorizontalAlign="Left" />
            </telerik:GridBoundColumn>
