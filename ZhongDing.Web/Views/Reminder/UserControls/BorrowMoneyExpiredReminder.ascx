<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BorrowMoneyExpiredReminder.ascx.cs" Inherits="ZhongDing.Web.Views.Reminder.UserControls.BorrowMoneyExpiredReminder" %>
    ...
    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
        ...
        <Columns>
            <telerik:GridBoundColumn UniqueName="ID" HeaderText="ID" DataField="ID" Visible="false">
              ...
              <telerik:GridTemplateColumn UniqueName="BorrowName" HeaderText="借款人">
                <ItemStyle HorizontalAlign="Left"  />
                <ItemTemplate>
                    <a target="_blank" href='<%# Page.ResolveUrl("~/Views/Basics/BorrowMoneyMaintenance.aspx?EntityID="+DataBinder.Eval(Container.DataItem,"ID").ToString())%>'>
                        <%# DataBinder.Eval(Container.DataItem,"BorrowName")%></a>
                </ItemTemplate>
