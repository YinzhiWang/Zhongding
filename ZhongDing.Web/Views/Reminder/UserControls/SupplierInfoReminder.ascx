<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplierInfoReminder.ascx.cs" Inherits="ZhongDing.Web.Views.Reminder.UserControls.SupplierInfoReminder" %>
...
<telerik:RadGrid ID="rgEntities" runat="server" PageSize="10"
    ...
    <MasterTableView Width="100%" DataKeyNames="SupplierID" CommandItemDisplay="Top"
        ...
        <Columns>
            <telerik:GridBoundColumn UniqueName="ID" HeaderText="ID" DataField="ID" Visible="false">
             ...
             <telerik:GridTemplateColumn UniqueName="SupplierCode" HeaderText="供应商编号">
                <ItemStyle HorizontalAlign="Left"  />
                <ItemTemplate>
                    <a target="_blank" href='<%# Page.ResolveUrl("~/Views/Basics/SupplierMaintenance.aspx?SupplierID="+DataBinder.Eval(Container.DataItem,"SupplierID").ToString())%>'>
                        <%# DataBinder.Eval(Container.DataItem,"SupplierCode")%></a>
                </ItemTemplate>
