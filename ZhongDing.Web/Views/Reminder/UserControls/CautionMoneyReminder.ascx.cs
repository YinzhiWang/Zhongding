...
{
    public partial class CautionMoneyReminder : BaseReminder
    {
        ...
        {
            return EPermission.CautionMoneyReminder;
        }
        ...
        private void BindReminders(bool isNeedRebind)
        {
            ...
            var entities = PageReminderRepository.GetUICautionMoneyReminder(uiSearchObj, rgEntities.CurrentPageIndex, rgEntities.PageSize, out totalRecords);
