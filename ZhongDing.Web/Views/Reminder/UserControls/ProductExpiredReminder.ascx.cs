...
{
    public partial class ProductExpiredReminder : BaseReminder
    {
        ...
        {
            return EPermission.ProductExpiredReminder;
        }
        ...
        private void BindReminders(bool isNeedRebind)
        {
            ...
            var entities = PageReminderRepository.GetUIProductExpiredReminder(uiSearchObj, rgEntities.CurrentPageIndex, rgEntities.PageSize, out totalRecords);
