<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClientInfoReminder.ascx.cs" Inherits="ZhongDing.Web.Views.Reminder.UserControls.ClientInfoReminder" %>
...
<telerik:RadGrid ID="rgEntities" runat="server" PageSize="10"
    ...
    <MasterTableView Width="100%" DataKeyNames="ClientInfoID" CommandItemDisplay="Top"
        ...
        <Columns>
            ...
            <telerik:GridBoundColumn UniqueName="ClientName" HeaderText="客户名称" DataField="ClientName">
             ...
             <telerik:GridTemplateColumn UniqueName="ClientCompanyName" HeaderText="商业单位">
                <ItemStyle HorizontalAlign="Left"  />
                <ItemTemplate>
                    <a target="_blank" href='<%# Page.ResolveUrl("~/Views/Basics/ClientCompanyMaintenance.aspx?EntityID="+DataBinder.Eval(Container.DataItem,"ClientCompanyID").ToString())%>'>
                        <%# DataBinder.Eval(Container.DataItem,"ClientCompanyName")%></a>
                </ItemTemplate>
