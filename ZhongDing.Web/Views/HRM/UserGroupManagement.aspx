        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnSearch">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="rgUserGroups" LoadingPanelID="loadingPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="rgUserGroups">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgUserGroups" LoadingPanelID="loadingPanel" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">用户组管理</span>
            </div>
            <div class="mws-panel-body">
                <table runat="server" id="tblSearch" class="leftmargin10">
                    <tr class="height40">
                        ...
                        <td class="middle-td leftpadding10 width50-percent">
                            <telerik:RadTextBox runat="server" ID="txtGroupName" Label="用户组名称：" LabelWidth="100px" Width="200px" MaxLength="100"></telerik:RadTextBox>
                        </td>
                ...
                <telerik:RadGrid ID="rgUserGroups" runat="server" PageSize="10"
                    AllowPaging="True" AllowCustomPaging="true" AllowSorting="True" AutoGenerateColumns="false"
                    MasterTableView-PagerStyle-AlwaysVisible="true" Skin="Silk" Width="99.8%" ShowHeader="true"
                    ClientSettings-ClientEvents-OnRowMouseOver="onRowMouseOver" ClientSettings-ClientEvents-OnRowMouseOut="onRowMouseOut"
                    OnNeedDataSource="rgUserGroups_NeedDataSource" OnDeleteCommand="rgUserGroups_DeleteCommand"
                    OnItemCreated="rgUserGroups_ItemCreated" OnColumnCreated="rgUserGroups_ColumnCreated" OnItemDataBound="rgUserGroups_ItemDataBound">
                    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="GroupName" HeaderText="用户组名称" DataField="GroupName">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="Comment" HeaderText="用户组描述" DataField="Comment">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn UniqueName="UserNames" HeaderText="用户" DataField="UserNames">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            
                            <telerik:GridTemplateColumn UniqueName="SetPermission" HeaderStyle-Width="80">
                                <ItemStyle HorizontalAlign="Center" Width="40" />
                                <ItemTemplate>
                                    <a href="javascript:void(0);" onclick="redirectToUserGroupPermissionMaintenancePage(<%#DataBinder.Eval(Container.DataItem,"ID")%>)">
                                        <u>设置权限</u></a>
                                </ItemTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "UserGroupMaintenance.aspx?EntityID=" + id;
        }
        function redirectToUserGroupPermissionMaintenancePage(id) {
            $.showLoading();
            window.location.href = "UserGroupPermissionMaintenance.aspx?EntityID=" + id;
        }
