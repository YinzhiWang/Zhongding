<%@ Page Title="部门管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DepartmentManagement.aspx.cs" Inherits="ZhongDing.Web.Views.HRM.DepartmentManagement" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">部门管理</span>
            </div>
            <div class="mws-panel-body">
                <table runat="server" id="tblSearch" class="leftmargin10">
                    <tr class="height40">
                        <td class="middle-td leftpadding10">
                            <telerik:RadTextBox runat="server" ID="txtEntityName" Label="部门名称：" LabelWidth="75" Width="200" MaxLength="100"></telerik:RadTextBox>
                        </td>
                ...
                <telerik:RadGrid ID="rgEntities" runat="server" PageSize="10"
                    ...
                    <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="DepartmentName" HeaderText="部门名称" DataField="DepartmentName">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="DepartmentType" HeaderText="部门性质" DataField="DepartmentType">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="DirectorUserName" HeaderText="部门经理" DataField="DirectorUserName">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn UniqueName="DeptDistrict" HeaderText="负责地区" DataField="DeptDistrict">
                                <ItemStyle HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "DepartmentMaintenance.aspx?EntityID=" + id;
        }
    </script>
</asp:Content>
