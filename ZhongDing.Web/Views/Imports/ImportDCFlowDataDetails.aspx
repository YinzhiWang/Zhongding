<%@ Page Title="配送公司流向数据导入结果" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImportDCFlowDataDetails.aspx.cs" Inherits="ZhongDing.Web.Views.Imports.ImportDCFlowDataDetails" %>
                ...
                <div class="mws-form">
                    <div class="mws-form-inline">
                                        ...
                                        <telerik:RadGrid ID="rgSucceedLogs" runat="server" PageSize="10"
                                            ...
                                            <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn UniqueName="FlowTo" HeaderText="流向" DataField="FlowTo">
                                                        <HeaderStyle Width="10%" />
                                                        <ItemStyle HorizontalAlign="Left" Width="10%" />
                                                    </telerik:GridBoundColumn>
                                                </Columns>
                        ...
                        <div class="mws-button-row">
                            <asp:Button ID="btnCancel" runat="server" Text="返回" UseSubmitBehavior="false" CssClass="mws-button green" OnClientClick="redirectToPage('Views/Imports/ImportDCFlowData.aspx');return false;" />
                        </div>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToManagementPage(sender, args) {
            redirectToPage("Views/Imports/ImportDCFlowData.aspx");
        }
