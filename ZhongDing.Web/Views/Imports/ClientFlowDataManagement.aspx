<%@ Page Title="商业客户销售流向数据" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientFlowDataManagement.aspx.cs" Inherits="ZhongDing.Web.Views.Imports.ClientFlowDataManagement" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">商业客户销售流向数据</span>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToImportPage() {
            $.showLoading();
            window.location.href = "ImportClientFlowData.aspx";
        }
