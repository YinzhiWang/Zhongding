<%@ Page Title="配送公司库存数据导入结果" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImportDCInventoryDataDetails.aspx.cs" Inherits="ZhongDing.Web.Views.Imports.ImportDCInventoryDataDetails" %>
    ...
    <div class="container">
        <div class="mws-panel grid_full">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-sign-post">配送公司库存数据导入结果</span>
            </div>
                    ...
                    <div class="mws-form-inline">
                        ...
                        <div class="mws-form-row">
                            <div class="float-left width50-percent">
                                <label>配送公司</label>
                                <div class="mws-form-item toppadding5">
                                    <asp:Label ID="lblDistributionCompanyName" runat="server"></asp:Label>
                                </div>
                            </div>
                            <div class="float-left">
                                <label>结算年月</label>
                                <div class="mws-form-item toppadding5">
                                    <asp:Label ID="lblSettlementDate" runat="server"></asp:Label>
                                </div>
                            </div>
                        </div>
                        <div class="mws-form-row">
                        ...
                        <div class="mws-button-row">
                            <asp:Button ID="btnCancel" runat="server" Text="返回" UseSubmitBehavior="false" CssClass="mws-button green" OnClientClick="redirectToPage('Views/Imports/ImportDCInventoryData.aspx');return false;" />
                        </div>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToManagementPage(sender, args) {
            redirectToPage("Views/Imports/ImportDCInventoryData.aspx");
        }
