<%@ Page Title="配送公司库存数据导入结果" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProcureOrderImportDataDetails.aspx.cs" Inherits="ZhongDing.Web.Views.Imports.ProcureOrderImportDataDetails" %>
                ...
                <div class="mws-form">
                    <div class="mws-form-inline">
                                            ...
                                            <MasterTableView Width="100%" DataKeyNames="ID" CommandItemDisplay="Top"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn UniqueName="EstDeliveryDate" HeaderText="交货日期" DataField="EstDeliveryDate" DataFormatString="{0:yyyy/MM/dd}">
                                                     ...
                                                     <telerik:GridBoundColumn UniqueName="WarehouseName" HeaderText="入库仓库" DataField="WarehouseName">
                                                    ...
                                                    <telerik:GridBoundColumn UniqueName="WarehouseName" HeaderText="基本单位" DataField="WarehouseName">
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </telerik:GridBoundColumn>
                        ...
                        <div class="mws-button-row">
                            <asp:Button ID="btnCancel" runat="server" Text="返回" UseSubmitBehavior="false" CssClass="mws-button green" OnClientClick="redirectToPage('Views/Imports/ProcureOrderImportData.aspx');return false;" />
                        </div>
                    </div>
                </div>
            </div>
