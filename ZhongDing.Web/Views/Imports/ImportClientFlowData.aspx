<%@ Page Title="商业客户流向数据导入" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImportClientFlowData.aspx.cs" Inherits="ZhongDing.Web.Views.Imports.ImportClientFlowData" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">商业客户流向数据导入</span>
            </div>
                        ...
                        <div runat="server" id="divSearch">
                            ...
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item">
                                    ...
                                    &nbsp;&nbsp;
                                    <asp:Button ID="btnCancel" runat="server" Text="返回" UseSubmitBehavior="false" CssClass="mws-button green" OnClientClick="redirectToPage('Views/Imports/ClientFlowDataManagement.aspx');return false;" />
                                    &nbsp;&nbsp;
                                    <asp:HyperLink ID="hlkModelExcel" runat="server" NavigateUrl="~/Content/Templates/XXXX客户流向数据(XXXX年XX月).xlsx">Excel模板下载</asp:HyperLink>
                                </div>
                            </div>
                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "ImportClientFlowDataDetails.aspx?EntityID=" + id;
        }

        function openUploadFileWindow(id) {
            $.showLoading();

            var targetUrl = $.getRootPath() + "Views/Imports/Editors/UploadClientFlowDataFile.aspx?EntityID=" + id
                + "&GridClientID=" + "<%= rgEntities.ClientID %>";

            $.openRadWindow(targetUrl, "winUploadClientFlowDataFile", true, 800, 340);
        }
