<%@ Page Title="配送公司流向数据" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientSaleApplicationDataManagement.aspx.cs" Inherits="ZhongDing.Web.Views.Imports.ClientSaleApplicationDataManagement" %>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-table-1">已导入客户订单</span>
            </div>
            <div class="mws-panel-body">
                <table runat="server" id="tblSearch" class="leftmargin10">
                    ...
                    <tr class="height40">
                        ...
                        <td class="middle-td leftpadding20" colspan="2"></td>
                    </tr>
                </table>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToImportPage() {
            $.showLoading();
            window.location.href = "ClientSaleApplicationImportData.aspx";
        }
