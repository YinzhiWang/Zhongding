<%@ Page Title="配送公司流向数据" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientSaleApplicationImportData.aspx.cs" Inherits="ZhongDing.Web.Views.Imports.ClientSaleApplicationImportData" %>
            ...
            <div class="mws-panel-body">
                ...
                <div class="mws-form">
                    <div class="mws-form-inline">
                        ...
                        <div class="mws-form-row">
                            <div class="float-left width40-percent">
                                ...
                                <div class="mws-form-item small">
                                    <telerik:RadComboBox runat="server" ID="rcbxSaleOrderType" Filter="Contains"
                                        AllowCustomText="false" Height="160px" Width="200px" EmptyMessage="--请选择--"
                                        AutoPostBack="false">
                                        <items>
                                            <telerik:RadComboBoxItem Text="招商模式" Value="2" />
                                            <telerik:RadComboBoxItem Text="挂靠模式" Value="3" />
                                        </items>
                                    </telerik:RadComboBox>
                                    <asp:CustomValidator ID="cvSaleOrderType" runat="server" ErrorMessage="请选择订单类型"
                                        ControlToValidate="rcbxSaleOrderType"
                        ...
                        <div class="mws-form-row">
                            <div class="float-left width40-percent">
                                <asp:Button ID="btnImportData" runat="server" Text="导入客户订单" CssClass="mws-button green" OnClick="btnImportData_Click"
                                    CausesValidation="true" ValidationGroup="vgMaintenance" />
                                &nbsp;&nbsp; &nbsp;&nbsp;
                                     <asp:HyperLink ID="hlkModelExcel" runat="server" NavigateUrl="~/Content/Templates/XXXX客户订单导入(XXXX年XX月).xlsx">Excel模板下载</asp:HyperLink>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContent" runat="server">
    <script type="text/javascript">
        ...
        function redirectToMaintenancePage(id) {
            $.showLoading();
            window.location.href = "ClientSaleApplicationImportDataDetails.aspx?EntityID=" + id;
        }
