...
{
    public partial class ImportDCInventoryDataDetails : BasePage
    {
        #region Members
            ...
            get
            {
                if (_CurrentEntity == null)
                    if (this.CurrentEntityID.HasValue && this.CurrentEntityID > 0)
                    {
                        ...
                        if (_CurrentEntity != null && _CurrentEntity.ImportDataTypeID != (int)EImportDataType.DCInventoryData)
                            _CurrentEntity = null;
                    }
        ...
        protected void rgSucceedLogs_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            ...
            var entities = PageDCInventoryDataRepository.GetUIList(uiSearchObj, rgSucceedLogs.CurrentPageIndex, rgSucceedLogs.PageSize, out totalRecords);
