<%@ Page Title="采购订单导入记录" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProcureOrderImportData.aspx.cs" Inherits="ZhongDing.Web.Views.Imports.ProcureOrderImportData" %>
            ...
            <div class="mws-panel-body">
                ...
                <div class="mws-form">
                    <div class="mws-form-inline">
                        ...
                        <div class="mws-form-row">
                            <div class="float-left width40-percent">
                                <asp:Button ID="btnImportData" runat="server" Text="导入采购订单" CssClass="mws-button green" OnClick="btnImportData_Click"
                                    CausesValidation="true" ValidationGroup="vgMaintenance" />
                                   &nbsp;&nbsp; &nbsp;&nbsp;
                                     <asp:HyperLink ID="hlkModelExcel" runat="server" NavigateUrl="~/Content/Templates/XXXX采购订单导入(XXXX年XX月).xlsx">Excel模板下载</asp:HyperLink>
