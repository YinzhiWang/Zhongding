...
{
    public interface IProductRepository : IBaseRepository<Product>, IAutoSerialNo, IGenerateDropdownItems
    {
        /// <summary>
        /// 获取UI List，不分页
        /// </summary>
        ...
        IList<UIProduct> GetUIList(UISearchProduct uiSearchObj = null);
